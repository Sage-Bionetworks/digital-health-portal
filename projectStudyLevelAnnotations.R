...
projects.annotations <- list(
  ...
  'syn23277418' = list(consortium = 'mHealth',
                      ...
                      studyDescription = 'This project represents the outputs and intermediate results of the analysis presented in mPower Nature Biotech Submission. The analysis presented here corresponds to a re-analysis of the data presented in the paper using the data that participants consented to share broadly. For summary statistics and trained models, we have also chosen to share the outputs from the complete dataset used in the paper. Each section will be divided into different kinds of analyses based on the paper that show what are the preliminary data requirements, figure input matrix, which code to run, and a preview of the figure.',
